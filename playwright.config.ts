 ...
 *
 * This configuration sets up end-to-end testing for CertLab's critical user journeys.
 * Tests run against a local development server and cover authentication, quiz flows,
 * achievements, and other core features.
 *
