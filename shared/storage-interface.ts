...
export interface IServerStorage extends IStorageAdapter {
  ...
  createTenantCategory(
    tenantId: number,
    category: Omit<InsertCategory, 'tenantId'>
  ): Promise<Category>;
  ...
  updateTenantCategory(
    tenantId: number,
    categoryId: number,
    updates: Partial<Omit<InsertCategory, 'tenantId'>>
  ): Promise<Category>;
  ...
  createTenantSubcategory(
    tenantId: number,
    subcategory: Omit<InsertSubcategory, 'tenantId'>
  ): Promise<Subcategory>;
  ...
  updateTenantSubcategory(
    tenantId: number,
    subcategoryId: number,
    updates: Partial<Omit<InsertSubcategory, 'tenantId'>>
  ): Promise<Subcategory>;
  ...
  updatePracticeTest(
    id: number,
    updates: Partial<InsertPracticeTest>
...
export interface IClientStorage extends IStorageAdapter {
  ...
  /** Get quests by type (daily, weekly, monthly) */
  getQuestsByType(type: string): Promise<Quest[]>;

  /** Get all user quest progress records */
